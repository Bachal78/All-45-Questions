...
let qoute1: string = "A persion who never made a mistake never tried anything new.";
let author: string = "Albert Einstein";
console.log(`${author} once said, ${qoute1}`);

//Task5
let qoute: string = '"A persion who never made a mistake never tried anything new."';
...
//Task11
let members1: string[]= ['Alli', 'Azam', 'Shoaib', 'Zain'];
for(let i=0; i<members1.length; i++){
    console.log(members1[i]);
}

//Task12
let members: string[]= ['Alli', 'Azam', 'Shoaib', 'Zain'];
let messages: string= 'Bring your Laptop; ';
for(let i=0; i<members.length; i++){
    console.log(messages + members[i]);
}

//Task13
let transport: string[]= ['BMW', 'Civic','Honda', 'Yaris', 'Alto'];
for (let i=0; i<transport.length; i++){
    console.log('I would like to own a '+ transport[i]);
}

//Task14
let guestlist: string[]=['Raja','Nasem','Nado'];
let message:string='Inviting them to dinner ';
...
//Task16
let guest_list2: string[]=['Raja','Nasem','Nado'];
let not_present2: string='Nado';
let new_guest4: string = 'Babar';
...
//Task17
let guest_list: string[]=['Raja','Nasem','Nado'];
let not_present: string='Nado';
...
let places: string[]= ['Karachi', 'Hyderabad', 'Larkana', 'Islamabad', 'New york'];
...
//Task20
let countries: string[] = ['Pakistan', 'UK', 'Malysia', 'Qutar', 'Russia'];
...
//Task22
let arry: string[]=['babar', 'tala',"4","5"];
console.log(arry[5]);
// above will show undefined error
let arry1: string[]=['babar', 'ali', 'tala', "4","5"];
console.log(arry1[0]);
console.log(arry1[1]);
console.log(arry1[2]);
console.log(arry1[3]);
...
//Task28
let age: number = 26 // tey different age, will get different result
if(age <2 ){
...
let favorite_fruits: string [] = ['apples','banana', 'grapes', 'melon', 'straberry']
...
let users:string[] = ["Ali", 'Azam', 'Zain', 'Zuhaib', 'admin']
...
let user:string[] = ["Ali", 'Azam', 'Zain', 'Zuhaib', 'admin']
if(user.length === 0){
...
//Task32
let current_users:string []=['admin', 'Naseem', 'maaz','Kareem',  'Naveed']
let new_users: string[]=['Javeed', 'Raja', 'Zahid','admin', 'maaz']
...
let fav_pizza: string []=["cheez pizza", "chiken pizza", "veg pizza"]
...
//Task35
let animals:string []= ["cat", "monkey", "lion"]
...
function make_shirt5 (size: string, text: string): void {
...
const magician: string[] =  ['Sheraz', 'Hamza', 'Bilwal'];
...
const magicians2: string []= ['Sheraz', 'Hamza', 'Bilwal'];
...
const magicians4: string[] = ["usama", "haseeb", "wajahat"];

const greatMagicians3: string []= make_great3(magicians4);
...
const mycar: car = createCar("totyat", 'corolla', {color: 'silver', year: "2024"});
console.log(mycar)